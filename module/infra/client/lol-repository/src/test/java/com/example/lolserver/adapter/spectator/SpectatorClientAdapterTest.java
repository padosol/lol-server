...
class SpectatorClientAdapterTest {
    ...
    @DisplayName("API 조회 성공 시 결과를 반환하고 캐시에 저장한다")
    @Test
    void getCurrentGameInfo_success_returnsAndCaches() {
        // given
        String region = "kr";
        String puuid = "test-puuid";
        CurrentGameInfoVO vo = createVO(12345L);
        CurrentGameInfoReadModel readModel = createReadModel(12345L);
    ...
    @DisplayName("API가 null을 반환하면 캐시 저장 없이 null 반환")
    @Test
    void getCurrentGameInfo_apiReturnsNull_returnsNullWithoutCache() {
        // given
        String region = "kr";
        String puuid = "test-puuid";
    ...
    private CurrentGameInfoVO createVO(long gameId) {
    ...
    private CurrentGameInfoReadModel createReadModel(long gameId) {
