...
CREATE TABLE summoner_ranking (
    ...
    CONSTRAINT unique_puuid_queue UNIQUE (puuid, queue)
);

CREATE INDEX idx_summoner_ranking_region_queue ON summoner_ranking (region, queue);
...
CREATE INDEX idx_summoner_ranking_backup_puuid_queue ON summoner_ranking_backup (puuid, queue);
