...
@DisplayName("QueueTypeController 테스트")
@ExtendWith(MockitoExtension.class)
class QueueTypeControllerTest extends RestDocsSupport {

    @Mock
    private QueueTypeUseCase queueTypeUseCase;

    @Override
    protected Object initController() {
        return new QueueTypeController(queueTypeUseCase);
    }
    ...
    void findAllQueueInfoForTab_큐탭정보조회_성공() throws Exception {
        ...
        given(queueTypeUseCase.findAllByIsTabTrue()).willReturn(queueInfos);
