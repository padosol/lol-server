...
class MatchMapperTest {
    ...
    void toPersistence_itemValue_returnsEntityItemValue() {
        ...
        // when
        com.example.lolserver.match.adapter.out.persistence.entity.value.matchsummoner.ItemValue result =
    ...
    void toEntity_match_returnsMatchEntity() {
        // given
        var match = com.example.lolserver.match.domain.Match.builder()
                .matchId("KR_12345")
                .queueId(420)
                .gameDuration(1800L)
                .gameMode("CLASSIC")
