...
public interface LeagueDomainMapper {
    ...
    @Mapping(target = "winRate", expression = "java("
            + "entity.getWins() + entity.getLosses() > 0 "
            + "? new java.math.BigDecimal(entity.getWins())"
            + ".divide(new java.math.BigDecimal(entity.getWins())"
            + ".add(new java.math.BigDecimal(entity.getLosses())), "
